...
<html lang="en">
<head>
<title>Rift valley technical training Institute</title>
...
<header>
	<div class="container agile-banner_nav">
		<nav class="navbar navbar-expand-lg navbar-light bg-light">
			...
			<h1><a class="navbar-brand" href="home.php">RVTTI<span class="display"></span></a></h1>
			...
			<div class="collapse navbar-collapse justify-content-center" id="navbarSupportedContent">
				<ul class="navbar-nav ml-auto">
					...
					<li class="nav-item">
					<a class="nav-link" href="payment/index.php">Make Payment</a>
					</li>
					<li class="nav-item">
...
<footer class="py-5">
	<div class="container py-md-5">
		<div class="footer-logo mb-5 text-center">
			<a class="navbar-brand" href="http://www.rvtti.ac.ke/" target="_blank">RVTTI <span class="display"> Institute</span></a>
		</div>
		<div class="footer-grid">
			...
			<div class="list-footer">
				<ul class="footer-nav text-center">
					...
					<li>
					<a href="payment/index.php">Make Payment</a>
					</li>
				</ul>
			</div>
		</div>
